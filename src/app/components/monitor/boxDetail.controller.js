...
(function () {
    ...
    angular.module('smart_container').controller('BoxDetailController', BoxDetailController);

    /** @ngInject */
    function BoxDetailController(constdata, NetworkService, MapService, $stateParams, ApiServer, toastr, $state, $timeout, $interval, $scope) {
